...
def fetch_dataset(split, offset=0, length=100):
    url = f"https://datasets-server.huggingface.co/rows?dataset=TheFinAI/flare-german&config=default&split={split}&offset={offset}&length={length}"
...
def prepare_credit_scoring_data(data_path):
